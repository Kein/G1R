...
#include "HitCapsuleCollisionComponent.generated.h"

class AActor;
class UWeaponDefinition;

UCLASS(EditInlineNew, ClassGroup=Custom, meta=(BlueprintSpawnableComponent))
class G1R_API UHitCapsuleCollisionComponent : public UCapsuleComponent, public IHitCollisionInterface {
    GENERATED_BODY()
public:
protected:
...
public:
    UHitCapsuleCollisionComponent(const FObjectInitializer& ObjectInitializer);
