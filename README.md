...
# Usage and building
0. It is assumed you have [UE5.4.3 AngelScript source](https://github.com/Hazelight/UnrealEngine-Angelscript) ((rev: `3d21e34009e78e1d7bc5cab1a29b709814d1cefb`) and the [UE build toolchain as well](https://github.com/EpicGames/UnrealEngine/blob/5.4.3-release/README.md) ( 14.36.32532 build tools and WinSDK 10.0.19041.0)
